...
export const personalDetails = {
  ...
  resumeLink: "https://drive.google.com/file/d/1VE7pTtJbT8NeGECVSQwp4QwkvPLKJwEh/view?usp=sharing", 
  about: {
...
export const projects: Project[] = [
  {
    ...
    mainStack: ["Next.js","TypeScript","Tailwind CSS","Shadcn UI","Node.js", "Express", "Prisma","Stripe","PostgreSQL","Zod","jwt", ],
    liveLink: "https://last-app-client.vercel.app/",
    repoLink: "https://github.com/sakin111/last-app-client",
    challenges: "Implementing Travel architecture and design was challenging. Ensuring user data privacy and optimizing database queries for finding travelers also complex.",
  ...
  },
  {
    ...
    description: "A secure and efficient wallet application for managing personal finances. (Details scraped from provided link were minimal, assumed generic wallet features).",
    mainStack: ["React","TypeScript","Redux Toolkit","Framer-motion","Shadcn UI", "Tailwind CSS","Node.js", "Express", "MongoDB", "Mongoose","JWT","Zod"],
    ...
    improvements: "Adding visualization charts for expenses and income, and integrating AI-driven budgeting tips also payment gateway for premium features.",
  },
  {
    id: "blog-app",
    name: "Blog App",
    ...
    mainStack: ["Next.js", "TypeScript", "Tailwind CSS", "Shadcn UI","Node.js", "Express","Prisma","JWT","Zod"],
